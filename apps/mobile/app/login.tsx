...
// Email y contraseña en todas las plataformas (registra la cuenta si no existe);
// Google real (popup) solo en Web — en móvil no hay popups y el nativo requiere development build (D-014).
